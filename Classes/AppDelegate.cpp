...
bool AppDelegate::applicationDidFinishLaunching() {
    ...
    if(!glview) {
		...
		glview = GLViewImpl::createWithRect("AstePang", cocos2d::Rect(0, 0, designResolutionSize.width * scale, designResolutionSize.height * scale));
#else
        glview = GLViewImpl::create("AstePang");
#endif
